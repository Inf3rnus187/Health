...
| Work ↔ health file | `import_logs`, `list_absences`, `save_absence`, `delete_absence`, `list_evidence`, `add_evidence` (proofs and traces), `import_traces`, `delete_evidence`, `sleep_nights`, `add_sleep_night`, `work_health` (PDF: `generate_report("work_health")`) |
